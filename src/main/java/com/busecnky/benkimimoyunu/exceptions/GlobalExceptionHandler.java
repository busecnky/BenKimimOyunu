...
import static com.busecnky.benkimimoyunu.exceptions.ErrorType.BAD_REQUEST_ERROR;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(BenKimimOyunuException.class)
    @ResponseBody
    public ResponseEntity<EErrorMessage> handleSpringMonoException(BenKimimOyunuException exception){
